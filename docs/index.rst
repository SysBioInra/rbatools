Welcome to rbatools´'s documentation!
===================================

**rbatools** is a programming interface for Resource Balance Analysis (RBA) models (`https://rba.inrae.fr <https://rba.inrae.fr>`_) 
